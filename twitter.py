import discord, asyncio, oauth2, json, datetime, time, setting
...
async def show_tweets(message, screen_name, count, include_rts, embed):
    jsonResult = []
    ...
    tweets = get_user_timeline(client, screen_name, count, include_rts)
